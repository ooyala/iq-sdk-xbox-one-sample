...
*/
/// <reference path="ms-appx://Microsoft.Xbox.WinJS.1.0/js/base.js" />
...
/// <disable bugId="1580737">JS2001</disable>
...
(function transitionAnimationInit(global, WinJS, undefined) {
    ...
    function applyAction(element, action, execAction) {
        try {
            var animate = true;
            animate = WinJS.UI.isAnimationEnabled();
...
(function utilitiesInit(global, undefined) {
    ...
    WinJS.Namespace.define("WinJS.Utilities", {
        ...
        _tryFocus: function Utilities_tryFocus(elem, useSetActive) {
            ...
            // BUGBUG: Windows Blue Bugs: 173359 Trident allows focus to go to elements that it shouldn't sometimes.
...
(function navigationInit(WinJS, undefined) {
    ...
    var go = function (distance, fromStack, toStack, delta) {
        ...
        // On Xbox, if the backstack is empty then we make a request to the system-wide
        // system-wide back stack to go back to the application we were launched from.
        if (WinJS.Utilities.hasWinRT &&
            Windows.Xbox) {
            // We pass a dummy object for navigation state so that the raiseBeforeNavigate
            // doesn't throw exceptions.
            return raiseBeforeNavigate({ location: null, state: null }).
                then(function goBeforeCompleted(cancel) {
                    if (!cancel) {
                        Windows.Xbox.System.Launcher.navigateBackAsync();
                    } else {
                        return false;
                    }
                });
    ...
    WinJS.Namespace.define("WinJS.Navigation", {
        ...
        canGoBack: {
            get: function () {
                // On Xbox, there is always a place to go back to, because there is a system-wide back stack.
                if (WinJS.Utilities.hasWinRT &&
                    Windows.Xbox) {
                    return true;
                } else {
        ...
        back: function (distance) {
            ...
            if (XboxJS && XboxJS.Utilities) {
                if (XboxJS.Utilities._isTransitioning) {
                    return WinJS.Promise.wrap();
                }
                XboxJS.Utilities._isBackwardNavigation = true;
            }
        ...
        navigate: function (location, initialState) {
            ...
            if (XboxJS && XboxJS.Utilities) {
                ...
                XboxJS.Utilities._isBackwardNavigation = false;
            }
        ...
        Template: WinJS.Namespace._lazy(function () {
            return WinJS.Class.define(function Template_ctor(element, options) {
                ...
                _renderImpl: function (dataContext, container) {
                    ...
                    WinJS.Utilities.markDisposable(d, function () {
...
(function DOMWeakRefTableInit(global, undefined) {
    ...
    if (WinJS.Utilities.hasWinRT && global.msSetWeakWinRTProperty && global.msGetWeakWinRTProperty) {
        ...
        var scheduleCleanupIfNeeded = function scheduleCleanupIfNeeded() {
        ...
        var unscheduleCleanupIfNeeded = function unscheduleCleanupIfNeeded() {
        ...
        var createWeakRef = function createWeakRef(element, id) {
            table[id] = { element: element, time: Date.now() };
            scheduleCleanupIfNeeded();
            return id;
        };

        var getWeakRefElement = function getWeakRefElement(id) {
