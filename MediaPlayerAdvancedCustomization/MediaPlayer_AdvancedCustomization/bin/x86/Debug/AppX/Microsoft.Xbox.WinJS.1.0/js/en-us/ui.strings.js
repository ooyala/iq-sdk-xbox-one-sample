...

{
    ...
    "off" : "Off",
    "on" : "On",
    "optimizeEdgeLoadingIsInvalid" : "Invalid argument: optimizeEdgeLoading must be a boolean.",
    ...
    "tooManyTemplateChildren" : "Repeater's template property may only define a single root node.",
    "unrated": "Unrated",
    ...
    "BACK_COMMAND_VUI_ALM"                   : "Go back",
    "_BACK_COMMAND_VUI_ALM.comment"          : "Button to previous page of the application. No GUI.",
    "BACK_COMMAND_VUI_PRON"                  : "STRING_EMPTY",
    "_BACK_COMMAND_VUI_PRON.comment"         : "Button to previous page of the application. No GUI.",
    "BACK_COMMAND_VUI_CONF"                  : "0.0",
    "_BACK_COMMAND_VUI_CONF.comment"         : "Button to previous page of the application. No GUI.",
    "CLOSE_COMMAND_VUI_ALM"                  : "Close",
    "_CLOSE_COMMAND_VUI_ALM.comment"         : "Button to close the current menu. No GUI.",
    "CLOSE_COMMAND_VUI_PRON"                 : "STRING_EMPTY",
    "_CLOSE_COMMAND_VUI_PRON.comment"        : "Button to close the current menu. No GUI.",
    "CLOSE_COMMAND_VUI_CONF"                 : "0.0",
    "_CLOSE_COMMAND_VUI_CONF.comment"        : "Button to close the current menu. No GUI."
